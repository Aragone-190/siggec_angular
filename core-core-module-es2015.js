...
let CoreComponent = class CoreComponent {
    constructor(permissionsService, authenticationService, rolesServices, layoutStore, ngxrolesService) {
...
const antDesignIcons = _ant_design_icons_angular_icons__WEBPACK_IMPORTED_MODULE_16__;
...
let HeaderInnerComponent = class HeaderInnerComponent {
...
HeaderInnerComponent.ctorParameters = () => [
...
let SidebarLeftInnerComponent = class SidebarLeftInnerComponent {
...
SidebarLeftInnerComponent.ctorParameters = () => [
...
let SidebarRightInnerComponent = class SidebarRightInnerComponent {
    constructor(modalService, toastr, formBuilder, rolesServices, authenticationService, layoutStore, ngxrolesService) {
    ...
    ngOnInit() {
        ...
        this.rolesServices.getRoles().
            subscribe(roles => {
            this.roles = roles;
            this.countRoles = Object.keys((lodash__WEBPACK_IMPORTED_MODULE_8__["countBy"](this.roles, 'id_role'))).length;
        }, err => {
            console.log(err);
        });
    }
    ...
    onSubmitAgregarRole() {
        ...
        let role = new src_app_models_role__WEBPACK_IMPORTED_MODULE_6__["Roles"](null, this.AgregarRoleForm.get('agregarRole').value);
    ...
    handleCancelMotrarPermisos() {
        this.isVisibleMostrarPermisos = false;
        this.checkedKeys = [];
        this.submittedEditarRole = false;
        this.isLoading = true;
    }
    onSubmitMostrarPermisos() {
        this.submittedEditarRole = true;
        this.isConfirmLoading = false;
        if (this.EditarRoleForm.invalid) {
            return;
        }
        let role = new src_app_models_role__WEBPACK_IMPORTED_MODULE_6__["Roles"](this.roleDataSelected.id_role, this.EditarRoleForm.get('editarRole').value);
    ...
    handleCancelAgregarModulo() {
        this.isVisibleAgregarModulo = false;
    }
    onSubmitAgregarModulos() {
        this.isConfirmLoadingAgregarModulo = true;
        let role = new src_app_models_role__WEBPACK_IMPORTED_MODULE_6__["Roles"](this.roleDataSelected.id_role, null);
...
SidebarRightInnerComponent.ctorParameters = () => [
