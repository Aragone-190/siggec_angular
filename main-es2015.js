...
let AppComponent = class AppComponent {
    constructor(layoutService, router, authenticationService) {
...
const config = { url: _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].url_api, options: {} };
...
class Roles {
    constructor(id_role, nombre_role) {
...
class User {
    constructor(id_usuario, nombre_empleado, nombre_usuario, contrasena, id_role, status, cargo, fecha_creacion, fecha_ultima_modificacion, fecha_modificacion_por, nombre_role, creado_por, token) {
...
let AuthentificationService = class AuthentificationService {
    constructor(http, permissionsService, roleService) {
        this.http = http;
...
let RolesService = class RolesService {
    ...
    getCheckedKeysPermissions(id_role) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let defaultCheckedKeys = [];
            let modulesRole = yield this.getRolesPermisos(id_role).toPromise();
            if (modulesRole.Roles.length === 0) {
                return defaultCheckedKeys;
            }
            lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](modulesRole.Roles[0].PermisosNivel1, (value1, key) => {
                defaultCheckedKeys.push(value1.nombre_permiso);
                if (value1.PermisosNivel2.length > 0) {
                    lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](value1.PermisosNivel2, (value2, key) => {
    ...
    getCheckedKeysModules(id_role) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let defaultCheckedKeys = [];
            let modulesRole = yield this.getRolesModulos(id_role).toPromise();
            if (modulesRole.Roles.length === 0) {
                return defaultCheckedKeys;
            }
            lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](modulesRole.Roles[0].ModulosPermisos, (valueModulos, key) => {
                defaultCheckedKeys.push(valueModulos.id_modulo);
            });
            return defaultCheckedKeys;
        });
    }
    getTreePermissions(id_role) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let nodes = [];
            let Nivel1 = [];
            let Nivel2 = [];
            let modules = yield this.getRolesModulos(id_role).toPromise();
            let permissions = yield this.getTreeRolesAll().toPromise();
            if (modules.Roles.length === 0) {
                return nodes;
            }
            modules = modules.Roles[0].ModulosPermisos;
            permissions = permissions.Modulos;
            lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](modules, (valueModule, key) => {
                nodes.push({
                    title: valueModule.nombre_modulo,
                    key: `${String(valueModule.nombre_modulo).toLowerCase()}-${valueModule.id_modulo}`
                });
                lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](permissions, (valueModuleP, keyModule) => {
                    if (valueModule.id_modulo === valueModuleP.id_modulo) {
                        Nivel1 = [];
                        Nivel2 = [];
                        lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](valueModuleP.Permisos_Nivel_1s, (valueNivel1, keyNivel1) => {
                            Nivel1.push({
                            ...
                            if (valueNivel1.Permisos_Nivel_2s.length > 0) {
                                ...
                                lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](valueNivel1.Permisos_Nivel_2s, (valueNivel2, keyNivel2) => {
                                    Nivel2.push({
    ...
    getTreeModules() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let nodes = [];
            let modules = yield this.getTreeRolesAll().toPromise();
            modules = modules.Modulos;
            lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](modules, (value, key) => {
                nodes.push({
    ...
    getPermissions(id_role) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](modulesRole.Roles[0].ModulosPermisos, (valueModulos, key) => {
                ...
                lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](valueModulos.PermisosNivel1, (value1, key) => {
    ...
    addModule(role, modulos) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url_api}roles/${role.id_role}/modulos`, { modulos })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(result => {
            return result;
        }));
    }
    updatePermissions(role, permisos) {
        let data = {
            nombre_role: role.nombre_role,
            permisos
        };
    ...
    setMenuPermissions(id_role) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](modulesRole.Roles[0].ModulosPermisos, (valueModulos, key) => {
                namesModules.push(String(valueModulos.nombre_modulo).toLowerCase().replace('/', ''));
            });
            yield lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](namesModules, (value, index) => {
                lodash__WEBPACK_IMPORTED_MODULE_5__["forEach"](_admin_lte_conf__WEBPACK_IMPORTED_MODULE_7__["adminLteConf"].sidebarLeftMenu, value2 => {
