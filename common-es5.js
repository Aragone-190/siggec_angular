(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Users = /** @class */ (function () {
                function Users(id, nombre, usuario, password, islogged, image, institucion, cargo, token, status, createAt) {
                    this.id = id;
                    this.nombre = nombre;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var peritosService = /** @class */ (function () {
                function peritosService(http) {
                    this.http = http;
                }
                peritosService.prototype.getFolderXPerito = function (nuc) {
                    return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].url_api + "getFolderXPerito/" + nuc).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (result) {
                ...
                peritosService.prototype.getIndiciosXPeritoAndFolder = function (usuario) {
                    return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].url_api + "getIndiciosXPeritoAndFolder/" + usuario).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (result) {
                        return JSON.parse(JSON.stringify(result.IndiciosPF)).map(function (item) {
                ...
                peritosService.prototype.getTotalFolderxPerito = function (user) {
                    var data = {
                        usuario: user
                    };
                    return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].url_api + "getTotalFolderxPerito", data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (result) {
                        return result.IndiciosPF;
                    }));
                };
                return peritosService;
            }());
            peritosService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.getCountUsers = function () {
                    return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url_api + "getCountUsers").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (result) {
                        return result.Total;
                    }));
                };
                UserService.prototype.getUsers = function () {
                    return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url_api + "usuario")
                        ...
                        console.log(result);
                        return JSON.parse(JSON.stringify(result.Usuarios)).map(function (item) {
                ...
                UserService.prototype.addUser = function (user) {
                    ...
                    console.log(data);
                    return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url_api + "usuario", data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (result) {
                        if (result.OK) {
                ...
                UserService.prototype.updateUser = function (nombre_empleado, nombre_usuario, contrasena, cargo) {
                    var data = {
                ...
                UserService.prototype.deleteUser = function (id_usuario) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsersService = /** @class */ (function () {
                ...
                UsersService.prototype.getCountUserApp = function () {
                    return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url_api + "getCountUserApp").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (result) {
                        return result.Total;
                    }));
                };
                UsersService.prototype.getUsersApp = function () {
                    return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url_api + "getUsuariosApp").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (result) {
                ...
                UsersService.prototype.addUserApp = function (user) {
                    var data = {
                        nombre: user.nombre,
                    ...
                    return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url_api + "AddUsuarioApp", data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (result) {
                        if (result.OK) {
                ...
                UsersService.prototype.updateUserApp = function (user) {
                    var data = {
                        nombre: user.nombre,
                        usuario: user.usuario,
                        password: user.password,
                    ...
                    console.log(data);
                    return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url_api + "updateUsuarioApp/" + user.id, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (result) {
                        if (result.OK) {
                            return result;
                        }
                        else {
                ...
                UsersService.prototype.deleteUserApp = function (id_usuario_app) {
                    return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url_api + "deleteUsuarioApp/" + id_usuario_app).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (result) {
                        return result;
                    }));
                };
                return UsersService;
